...
val project_r_closed_unprotected : Nodex.CP.t -> int list -> U.Trs.t World.Monad.t
val project_c : Nodex.CP.t -> int list -> U.Trs.t World.Monad.t
val of_axioms : Equation.t list -> int list World.Monad.t
val of_s_theory : int list World.Monad.t
val to_string : int list -> string World.Monad.t
val acs : Rewriting.Function.t list -> int list World.Monad.t
