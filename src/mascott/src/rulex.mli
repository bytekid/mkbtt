...
val rewrite :
 ...
 (U.Term.t * U.Substitution.t * U.Rule.t) U.Monad.t
...
val extend : U.Rule.t -> U.Rule.t option U.Monad.t

val distinct_terms : U.Rule.t -> bool
(** [distinct_terms rl] checks whether the left-hand side and the
 right-hand side of [rl] are different terms. *)

val readable : U.Rule.t -> U.Rule.t U.Monad.t

val unflatten: U.Rule.t -> U.Rule.t U.Monad.t
