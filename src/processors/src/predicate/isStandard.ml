...
(*** GLOBALS ******************************************************************)
let code = "standard";;
let name = "Standard Predicate";;
let comment = "Checks if the given problem is a standard problem (in \
               contrast to relative).";;
let keywords = ["standard";"is standard";"predicate"];;
