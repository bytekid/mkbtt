...
module MyProblem : sig
 ...
 val make_ep : 
  ...
  Processors.Problem.t
 val get_trs : t -> Trs.t
 val get_strict : t -> Trs.t
 val get_weak : t -> Trs.t
 val is_sp : t -> bool
 val is_rp : t -> bool
end
...
module MyXml : sig
 val of_channel : in_channel -> MyProblem.t * Signature.t
end
...
module MyProof : sig
 ...
 val fprintfx : MyStatus.t -> Format.formatter -> t -> unit Monad.t
 val to_stringx : MyStatus.t -> t -> string Monad.t
end
